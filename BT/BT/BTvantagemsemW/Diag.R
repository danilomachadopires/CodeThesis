...
save(dados1A,file="dados1A.rda");save(dados1B,file="dados1B.rda");save(dados1C,file="dados1C.rda")
...
segplot (Trat ~ LI + LS, center= dados1A$delta, col="gray50", 
...
segplot (Trat ~ LI + LS, center= dados1B$delta, col="gray50", 
         xlab="IC", ylab="Tratamentos",
         draw.bands=F, segments.fun=panel.arrows, ends="both",
         angle=90, length=1, unit="mm", las=2)
...
segplot (Trat ~ LI + LS, center= dados1C$delta, col="gray50", 
         xlab="IC", ylab="Tratamentos",
         draw.bands=F, segments.fun=panel.arrows, ends="both",
         angle=90, length=1, unit="mm", las=2)
