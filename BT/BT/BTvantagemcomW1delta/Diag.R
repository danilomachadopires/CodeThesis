...
rd.gamaB    <- raftery.diag(cadeia.gamaA)$resmatrix
...
apply(rd.gamaA,2,max);apply(rd.deltaA,2,max)
apply(rd.gamaB,2,max);apply(rd.deltaB,2,max)
apply(rd.gamaC,2,max);apply(rd.deltaC,2,max)
...
#delta
cbind(HPDinterval(cadeia.deltaA)[1],res.deltaA[1]$statistic[1],HPDinterval(cadeia.deltaA)[2])
cbind(HPDinterval(cadeia.deltaB)[1],res.deltaB[1]$statistic[1],HPDinterval(cadeia.deltaB)[2])
cbind(HPDinterval(cadeia.deltaC)[1],res.deltaC[1]$statistic[1],HPDinterval(cadeia.deltaC)[2])
