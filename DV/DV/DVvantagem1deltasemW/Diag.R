...
#delta
round(cbind(HPDinterval(cadeia.deltaA)[1],res.deltaA[1]$statistic[1],HPDinterval(cadeia.deltaA)[2]),4)
round(cbind(HPDinterval(cadeia.deltaB)[1],res.deltaB[1]$statistic[1],HPDinterval(cadeia.deltaB)[2]),4)
round(cbind(HPDinterval(cadeia.deltaC)[1],res.deltaC[1]$statistic[1],HPDinterval(cadeia.deltaC)[2]),4)
