...
rm(list=ls(all=T))
source("/home/danilomp/Qualifica/DV/DVvantagemSemW/FGSMH.R")

dados <- read.table("/home/danilomp/Qualifica/DV/DVvantagemSemW/granprix2010a2013.txt",h=T)
attach(dados)
...
load("/home/danilomp/Qualifica/DV/DVvantagemSemW/cgr.rda")
...
while (cont <= nsMC) {
  ...
  if(cont%%J==0 && cont>B){
    write(t(gama),"/home/danilomp/Qualifica/DV/DVvantagemSemW/cadeia.gamaA.txt",ncol=length(gama),append=TRUE)
    write(t(delta),"/home/danilomp/Qualifica/DV/DVvantagemSemW/cadeia.deltaA.txt",ncol=length(delta),append=TRUE)
    write(lambda,"/home/danilomp/Qualifica/DV/DVvantagemSemW/cadeia.lambdaA.txt",ncol=1,append=TRUE)
    ...
    lVm <- lLpi3(pi)
    write(lVm,"/home/danilomp/Qualifica/DV/DVvantagemSemW/cadeia.lVmA.txt",ncol=1,append=TRUE) 
